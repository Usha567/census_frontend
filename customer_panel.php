...
<head>
    ...
    <script src="http://localhost:8080/census_project\jsfile\customer_panel.js"></script> 
...
<header class="header">
    ...
    <div class="container mt-2 pb-5 text-end">
        <div>
            <a href="other_cast_data.php" class="text-decoration-none text-dark" onclick="othercast()">अंतर्जातीय</a>
        </div>
    </div>
